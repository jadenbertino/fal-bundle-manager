...
class TestIntegrationWorkflow:
    ...
    def test_complete_workflow_single_file(
        self, mock_download_client, mock_list_client, mock_create_client, runner
    ):
        ...
        assert extracted_hash == file_hash, (
            f"Hash mismatch: expected {file_hash}, got {extracted_hash}"
        )
    ...
    @patch("cli.commands.create.BundlesAPIClient")
    @patch("cli.commands.download.BundlesAPIClient")
    def test_complex_directory_workflow(
        self, mock_download_client, mock_create_client, runner
    ):
