...
def test_create_blob_new():
    ...
    content = b"test content for new blob"
...
def test_create_blob_hash_mismatch():
    ...
    blob_path = Path(".data") / "blobs" / wrong_hash[:2] / wrong_hash[2:4] / wrong_hash
...
def test_create_blob_fanout_structure():
    ...
    expected_path = Path(".data") / "blobs" / hash_val[:2] / hash_val[2:4] / hash_val
